...
block				:	(stdSecSeg1 | dispSeg1 ) comma? EOF;

//-------------------------------------------------------------------------------------------------------------------------
stdSecSeg1 			: 	STDSEC consideration? by grantor to grantee comma?; 
dispSeg1 			: 	DISP by grantor withConsent? to grantee comma?;
...
jdPersons			: 	jdCouple1 | jdCouple2 | jdCouple3 | jdCouple4 | jdCouple5 | jdCouple6  
						| jdPersonGrp1 | jdPersonGrp2 | jdPersonGrp3 ;
...
desigPerson			:	dpPattern1 | dpPattern2 | dpPattern3 | dpPattern4 | dpPattern5 | dpPattern6 
						| dpPattern6 | dpPattern7 | dpPattern8 | dpPattern9 | dpPattern10;
...
PROF_WORD       	: 'Accountant'| 'Adviser' | 'Advisor' | 'Advocate' | 'Agent' | 'Anaesthetist' | 'Analyst' | 'Apprentice' | 'Architect' | 'Assistant' | 'Auctioneer' 
					...
					| 'Underwriter' | 'Waiter' | 'Warden' | 'Warehouseman' | 'Watchmaker' | 'Welder' | 'Wholesaler' | 'Worker' | 'Writer' | 'Valuator' ;
